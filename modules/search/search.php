...
$total_row = mysqli_num_rows(mysqli_query($conn,"SELECT * FROM product WHERE prd_name LIKE '$str_key'"));
...
$sql = "SELECT * FROM product WHERE prd_name LIKE '$str_key' ORDER BY prd_id DESC LIMIT $per_row,$row_per_page" ;
