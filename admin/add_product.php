...
if(isset($_POST['sbm'])){
    ...
    $sql = "INSERT INTO product(prd_name, prd_price, prd_warranty, prd_accessories, prd_promotion, prd_image, prd_new,cat_id, prd_status, prd_featured, prd_details) VALUES ('$prd_name', $prd_price, '$prd_warranty', '$prd_accessories', '$prd_promotion', '$prd_image', '$prd_new', $cat_id , $prd_status, $prd_featured, '$prd_details') ";
