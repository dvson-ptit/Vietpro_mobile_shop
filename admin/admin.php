...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="<?php if($_GET['page_layout'] == 'ads' || $_GET['page_layout'] == 'edit_ads' || $_GET['page_layout'] == 'add_ads'){echo 'active';} ?>"><a href="index.php?page_layout=ads"><svg class="glyph stroked bag"><use xlink:href="#stroked-bag"></use></svg>Quản lý sản phẩm</a></li>
	...
	if(isset($_GET['page_layout'])){
		switch($_GET['page_layout']){
			...
			// ads
			case "ads": include_once("ads.php"); break;
			case "edit_ads": include_once("edit_ads.php"); break;
			case "add_ads": include_once("add_ads.php"); break;
		}
	}else{
